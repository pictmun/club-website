        ...
        <Carousel.Item interval={3000}>
          ...
          <Carousel.Caption>
            ...
            <p className='info'>
              ...
              organized four MUN Conferences for college students and conducts
              group discussions, extempore and debates regularly. The Club also
              organizes training workshops conducted by experienced and
              decorated MUNers for MUN enthusiasts from in and around the city.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item interval={3000}>
          ...
          <Carousel.Caption>
            ...
            <p className='info'>
              ...
              of discretion by assuming the role of the UN representative for an
              allocated nation or an individual from other global basic
              leadership bodies. It helps them to build up their capacities to
              work with other people who are similarly roused and energetic
              about discovering answers for Global Concerns. With the expanding
              closeness of nations over the World, the MUN has turned into a
              fairly mainstream practice all over.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item interval={3000}>
          ...
          <Carousel.Caption>
            ...
            <p className='info'>
              ...
              principles contained in its founding Charter. The UN also provides
              a forum for its members to express their views in the General
              ...
              members, and by hosting negotiations, the Organization has become
              a mechanism for governments to find areas of agreement and solve
              problems together.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
